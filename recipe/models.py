...
class Page(models.Model):
    """ Represents a single recipe page. """
    title = models.CharField(max_length=settings.RECIPE_PAGE_TITLE_MAX_LENGTH, unique=True,
                             help_text="Title of your page.")
    author = models.ForeignKey(User, on_delete=models.PROTECT,
                               help_text="The user that posted this article.")
    slug = models.CharField(max_length=settings.RECIPE_PAGE_TITLE_MAX_LENGTH, blank=True, editable=False,
    ...
    def get_absolute_url(self):
        """ Returns a fully-qualified path for a page (/my-new-recipe-page). """
        path_components = {'slug': self.slug}
        return reverse('recipe-details-page', kwargs=path_components)
